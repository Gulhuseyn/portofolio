...
import house from "../test.png"
const Hero=()=>{
    const output="web developer"
...
className="container">
    ...
    <h2>Hello,<br/>I am 
    <motion.div className="colored"  animate={{opacity:[0,1,0],top:[50,0,-50],content:"test1"}} transition={{duration: 1.5,delay:2}} ></motion.div>
